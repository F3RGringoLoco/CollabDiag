...
<div id="sample">
    ...
    <div>
        <h3>{{$nivel2->title}} - autor ({{$nivel2->author_name}})</h3>
    </div>
    ...
    <div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            ...
            <a href="{{route('nivel2.index')}}" class="btn btn-secondary">Volver Atrás</a> 
            Modelos de diagrama guardados en formato JSON:
        </div>
        <br>
        <textarea id="mySavedModel" style="width:100%;height:300px">
            @if ($nivel2->json_data == null)
        ...
        $(go.Palette, "myPaletteDiv",  // Refiere al elemento div
          {
            ...
            model: new go.GraphLinksModel([  // especifica el contenido de palette
                ...
                { text: "Container", figure: "Rectangle", fill: "skyblue" },
                { text: "Database", figure: "Triangle", fill: "indianred"},
                { text: "Mobile App", figure: "Border", fill: "skyblue"},
                { text: "Web Browser", figure: "Border", fill: "skyblue"},
                { text: "Person", figure: "Circle", fill: "deepskyblue" },
                { text: "Existing System", figure: "Rectangle", fill: "lightgray" },
            ], [
