...
<div id="sample">
    <div style="width: 100%; display: flex; justify-content: space-between">
        ...
        <div id="myDiagramDiv" onclick="Update()" style="flex-grow: 1; height: 620px; border: solid 1px black"></div>
        ...
        $(go.Palette, "myPaletteDiv",  // Refiere al elemento div
          {
            ...
            model: new go.GraphLinksModel([  // especifica el contenido de palette
              ...
              { text: "User", figure: "Border", fill: "deepskyblue" },
              { text: "Software System", figure: "Rectangle", fill: "skyblue"},
